...
class AIAgent:
    ...
    def __init__(
        ...
        compression_target_ratio = float(os.getenv("CONTEXT_COMPRESSION_TARGET_RATIO", "0.20"))
        compression_protect_last = int(os.getenv("CONTEXT_COMPRESSION_PROTECT_LAST_N", "20"))
